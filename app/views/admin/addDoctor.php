                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $adminModel->getDoctorNames($_SESSION["admin"]);?></span>
...
if(isset($_POST['register'])){
    ...
    $email = $_POST["email"];
    $dui = $_POST["dui"];
    $noJunta = $_POST["noJunta"];
    $age = $_POST["age"];
    $adminModel->registerDoctor($name, $lastname, $username, $_SESSION["doctor"], $password, $email, $dui, $noJunta, $age);
}
?>